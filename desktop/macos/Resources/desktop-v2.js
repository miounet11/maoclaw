...
const V2_COPY = {
  en: {
    ...
    setupNoteA: "The old shell is no longer the primary path. The host now opens the bundled V2 control center first.",
  ...
  zh: {
    ...
    saveAndLaunch: "保存并启动",
    saveDefaults: "保存默认值",
    setupNoteA: "旧的桌面壳层不再是主路径。宿主应用现在优先打开内置的 V2 控制中心。",
